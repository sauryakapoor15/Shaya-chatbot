#Don't remove This Line From Here. @TeamSukun | @cute_billa_hu
#Don't import only fork .
import requests
import random
import os
import re
...
STKR = os.environ.get("STKR", "CAACAgUAAxkDAAIddGP1zuAQr33YutwO6gvOqENZLdC1AAJ_CAACkUCxV_Q2z_DM3wuDLgQ")
STKR1 = os.environ.get("STKR1", "CAACAgUAAxkDAAIddGP1zuAQr33YutwO6gvOqENZLdC1AAJ_CAACkUCxV_Q2z_DM3wuDLgQ")
STKR2 = os.environ.get("STKR2", "CAACAgUAAxkDAAIddGP1zuAQr33YutwO6gvOqENZLdC1AAJ_CAACkUCxV_Q2z_DM3wuDLgQ")
STKR3 = os.environ.get("STKR3", "CAACAgUAAxkDAAIddGP1zuAQr33YutwO6gvOqENZLdC1AAJ_CAACkUCxV_Q2z_DM3wuDLgQ")
STKR4 = os.environ.get("STKR4", "CAACAgUAAxkDAAIddGP1zuAQr33YutwO6gvOqENZLdC1AAJ_CAACkUCxV_Q2z_DM3wuDLgQ")
STKR5 = os.environ.get("STKR5", "CAACAgUAAxkDAAIddGP1zuAQr33YutwO6gvOqENZLdC1AAJ_CAACkUCxV_Q2z_DM3wuDLgQ")
STKR6 = os.environ.get("STKR6", "CAACAgUAAxkDAAIddGP1zuAQr33YutwO6gvOqENZLdC1AAJ_CAACkUCxV_Q2z_DM3wuDLgQ")
STKR7 = os.environ.get("STKR7", "CAACAgUAAxkDAAIddGP1zuAQr33YutwO6gvOqENZLdC1AAJ_CAACkUCxV_Q2z_DM3wuDLgQ")
STKR8 = os.environ.get("STKR8", "CAACAgUAAxkDAAIddGP1zuAQr33YutwO6gvOqENZLdC1AAJ_CAACkUCxV_Q2z_DM3wuDLgQ")
...
SHAYA_OP = [
    ...
    [
        InlineKeyboardButton(text="🥀 ᴏᴡɴᴇʀ 1 🥀", url="tg://user?id=5950213418"),
        InlineKeyboardButton(text="✨ ᴏᴡɴᴇʀ 2 ✨", url="tg://user?id=6071623138"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="🤞 ᴍᴇᴇᴛ ᴍᴇ ʜᴇʀᴇ 🤞", url="https://t.me/+sryLW2nnvwRhNTFl"
        ),
    ],
]
PNG_BTN = [
    [
     ...
     [
         InlineKeyboardButton(
             text="✨ sᴜᴘᴘᴏʀᴛ ✨", 
             url="https://t.me/+sryLW2nnvwRhNTFl",
         ),
     ],
]
HELP_READ = f"""
...
**ʏᴏᴜ ᴄᴀɴ ᴄʜᴇᴄᴋ ᴛʜᴇ ʀᴇᴘᴏ ᴀɴᴅ ғᴏʀᴋ ɪᴛ**
**──────────────**
<b>||©️ @TeamSukun||</b>
"""
BACK = [
...
CLOSE_BTN = [
      [
          InlineKeyboardButton(text="✨ ʀᴇᴘᴏ ✨", url="https://github.com/TeamSukun/Shayachatbot"),
          InlineKeyboardButton(text="🫣 ᴍᴀɴᴀɢᴇʀ 🫣", url="https://t.me/cute_billa_hu"),
     ],
     [
          InlineKeyboardButton(text="✨ ʙᴀᴄᴋ ✨", callback_data="BACK"),
          InlineKeyboardButton(text="❄️ ᴄʟᴏsᴇ ❄️", callback_data="CLOSE"),
...
CHATBOT_ON = [
        [
            InlineKeyboardButton(text="⍟ ʟᴇᴛ ᴍᴇ ᴛᴀʟᴋ ⍟", callback_data=f"addchat"),
            InlineKeyboardButton(text="⍟ ɪ ᴡᴏɴ'ᴛ ᴛᴀʟᴋ ⍟", callback_data=f"rmchat"),
        ],
]
...
ABOUT_BTN = [
      ...
      [    
           InlineKeyboardButton(text="🍾 ᴍᴀɴᴀɢᴇʀ 🍾", url=f"https://t.me/{OWNER_USERNAME}"), 
           InlineKeyboardButton(text="✨ ʀᴇᴘᴏ ✨", url="https://github.com/TeamSukun/Shayachatbot"),
      ],
      [ 
           InlineKeyboardButton(text="✌️ ᴄʜᴀɴɴᴇʟ ✌️", url=f"https://t.me/{UPDATE_CHNL}"),  
           InlineKeyboardButton(text="✨ ʙᴀᴄᴋ ✨", callback_data="BACK"),
      ],
]
SOURCE_READ = f"**ʜᴇʏ, ᴛʜᴇ [sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ](https://github.com/TeamSukun/Shayachatbot) ᴏғ [{BOT_NAME}](https://t.me/{BOT_USERNAME}) ɪs ɢɪᴠᴇɴ.**\n**ᴘʟᴇᴀsᴇ ғᴏʀᴋ ᴛʜᴇ ʀᴇᴘᴏ & ɢɪᴠᴇ ᴛʜᴇ sᴛᴀʀ ᴛᴏ ᴛᴇᴀᴍ sᴜᴋᴜɴ ✯**\n**──────────────────**\n**ɪғ ʏᴏᴜ ᴀʟsᴏ ᴡᴀɴᴛ ʏᴏᴜʀ ᴄʜᴀᴛʙᴏᴛ ᴡɪᴛʜ ᴀʟʟ ᴇᴅɪᴛɪɴɢ ᴛʜᴇɴ ɪ ᴄᴀɴ ʜᴇʟᴘ ʜᴇʟᴘ ᴛᴏ ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ ᴀᴛ [ᴍᴀɴᴀɢᴇʀ](https://t.me/cute_billa_hu) **\n**──────────────────**\n**ɪғ ʏᴏᴜ ғᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ᴛʜᴇɴ ᴄᴏɴᴛᴀᴄᴛ ᴀᴛ [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ](https://t.me/{SUPPORT_GRP}).\n<b>||©️ @TeamSukun||</b>"
...
async def restart(client, m: Message):
    if m.chat.type == "private":
        ...
        await accha.edit("__sʜᴀʏᴀ ꨄ︎ ѕтαятιиg..__ by @TeamSukun")
        await asyncio.sleep(1.0)
        await accha.edit("__sʜᴀʏᴀ ꨄ sтαятιиg.....__by @TeamSukun")
        await asyncio.sleep(1.0)
        await accha.edit("__sʜᴀʏᴀ ꨄ︎ sтαятιиg..__by @TeamSukun")
        await asyncio.sleep(1.0)
        await accha.delete()
        ...
        await m.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(SHAYA_OP),
        )
...
@bot.on_message(filters.command("shaya") & filters.user(OWNER_ID))
async def get_st(_, msg: Message):
    users = len(await get_served_users())
    chats = len(await get_served_chats())
    await msg.reply_photo(
        photo="https://te.legra.ph/file/21c28dfbd9960f81ab40c.jpg",
...
print(f"{BOT_NAME} ɪs ᴀʟɪᴠᴇ! ɴᴏᴡ ғᴜᴄᴋ ᴏғғ! ᴀɴᴅ ɢᴏ ᴛᴏ @sukunsupports ʙɪᴛᴄʜ!!")      
bot.run()
